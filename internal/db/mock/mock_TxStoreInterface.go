...
func (_m *MockTxStoreInterface) CreateSession(ctx context.Context, arg db.CreateSessionParams) (*db.Session, error) {
	ret := _m.Called(ctx, arg)
...
func (_m *MockTxStoreInterface) GetSession(ctx context.Context, id uuid.UUID) (*db.Session, error) {
	ret := _m.Called(ctx, id)
